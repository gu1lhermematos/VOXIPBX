...
--
-- Estrutura da tabela "info_integrador"
--
...
--
-- Estrutura da tabela `group_resource`
--

CREATE TABLE IF NOT EXISTS `group_resource` (
  `id_group` varchar(50) character set utf8 NOT NULL,
  `id_resource` varchar(256) NOT NULL,
...
--
-- Restri��es para a tabela `group_resource`
--
ALTER TABLE `group_resource`
  ADD CONSTRAINT `fk_group_resource` FOREIGN KEY (`id_group`) REFERENCES `groups` (`name`) ON DELETE CASCADE ON UPDATE CASCADE;
