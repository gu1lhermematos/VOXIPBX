...
abstract class PBX_Rule_Action {
    ...
    /**
     * __construct - Inicializando config no construtor por padrão para 
     * evitar erros de runtime mais graves.
     */
    ...
    /**
     * execute - Executa a ação. É chamado dentro de uma instancia usando AGI.
    ...
    /**
     * getConfig - Método que auxilia na geração da interface fornecendo os 
     * parametros necessários pela ação.
    ...
    /**
     * getConfigArray - Retorna todas as configurações da interface para 
     * que seja feita a persistencia.
    ...
    /**
     * getDefaultConfigXML - Configurações padrão para todas as ações dessa 
     * classe. Essas possuem uma tela de configuração separada.
     *
    ...
    /**
     * getName - Retorna o nome da Ação. Geralmente o nome da classe.
     * @return <string> Name da Ação
     */
    abstract public function getName();

    /**
     * getRule - Retorna, se houver, uma regra de negócio dona dessa ação.
     * @return PBX_Rule
     */
    ...
    /**
     * getVersion - Retorna o numero da versão da classe.
     * @return <string> Versão da classe
     */
    abstract public function getVersion();

    /**
     * getDesc - Retorna uma breve descrição de funcionamento da ação.
     * @return <string> Descrição de funcionamento ou objetivo
     */
    abstract public function getDesc();

    /**
     * setConfig - Define parametros da regra.
     * @param <array> $config
     */
    ...
    /**
     * setDefaultConfig - Seta a configuração padrão para essa regra.
     * @param <array> $config
     */
    ...
    /**
     * setRule - Regra de negócio para ser considerada dona(chamadora) dessa ação.
     * @param PBX_Rule $rule
     */
