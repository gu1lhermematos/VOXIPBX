...
class Snep_Manutencao {
    ...
    /**
     * listaPeriodo - Lista calldate, userfield das ligações do periodo
    ...
    /**
     * listaStorage - Lista Unidade montadas como Storage
    ...
    /**
     * arquivoExiste - Busca arquivo de gravacao, retorna caminho do mesmo ou não
    ...
    /**
     * removeBackup - Remove arquivo de gravação
    ...
    /**
     * compactaArquivos - Compacta lista de arquivos
     * @param <string> $arquivo
