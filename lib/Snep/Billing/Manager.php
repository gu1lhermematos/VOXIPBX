...
class Snep_Billing_Manager {
    ...
    /**
     * editBilling - Update a billing item values
     * @param <int> $idBilling
     * @param <array> $values
     */
    ...
    /**
     * remove - Remove a billing and all bill tax.
     * @param <int> $id
     */
    ...
    /**
     * getBillingValues - Get all billing values
     * @param <int> $idCarrier
    ...
    /**
     * getCity - Return all cities by state
     * @return <array>
     */
