...
class Snep_Log {
    ...
    /**
     * getLog - Função para extrair um relatório conforme parametros passados
     * @param <Zend_Date> $dia_ini
     * @param <Zend_Date> $dia_fim
    ...
    /**
     * getTail - Função que extraí do arquivo as ultimas linhas conforme passado por parametro
     * @param type $n
     * @return type
     */
