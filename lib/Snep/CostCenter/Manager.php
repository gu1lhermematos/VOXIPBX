...
class Snep_CostCenter_Manager {
    ...
    /**
     * getAll - Method to get all cost centers
     */
    ...
    /**
     * get - Method to get Cost Center by id
     * @param <int> $id
     * @return <array>
     */
    ...
    /**
     * getInUse - Verify if $id has been used
     * @param <float> $id
     * @return type
     */
    public function getInUse($id) {

        $db = Zend_Registry::get('db');

        $select = $db->select()
                ->from("ccustos", array("codigo"))
                ->where("CONCAT(ccustos.codigo) LIKE '%$id%'");
    ...
    /**
     * add - Method to add a cost center.
    ...
    /**
     * remove - Method to remove a cost center
     * @param <int> $id
     */
    ...
    /**
     * edit - Method to update a cost center data
     * @param <array> $costcenter
     */
