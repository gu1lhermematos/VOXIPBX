...
class Snep_ContactGroups_Manager {
    ...
    /**
     * getAll - Method to get all contact groups
     */
    ...
    /**
     * get - Method to get a contact group by id
     * @param <int> $id
     * @return <array>
     */
    ...
    /**
     * add - Method to add a contact group.
     * @param <array> $group
     * @return <int>
     */
    ...
    /**
     * remove - Method to remove a contact group
     * @param <int> $id
     */
    ...
    /**
     * edit - Method to update a contact group data
     * @param <int> $id
     */
    ...
    /**
     * insertContactOnGroup - Method do insert contact on group
     * @param <int> $groupId
     * @param <int> $contactId
     */
    ...
    /**
     * getGroupContacts - Method do return all contacts by group id
     * @param <int> $id
     */
