...
class Snep_Carrier_Manager {
    ...
    /**
     * clearCostCenter - Clear all CostCenter associate with a Carrier
     * @param <int> $idCarrier
     */
    ...
    /**
     * getCarrierCostCenter - Return Carrier Cost Center's
     * @param <int> $idCarrier
     * @return <array> $_used
     */
    ...
    /**
     * getIdleCostCenter - Return all idle Cost Centers
     * @return <array>
     */
