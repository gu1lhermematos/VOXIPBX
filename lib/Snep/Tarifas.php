...
class Snep_Tarifas {
    ...
    /**
     * __get - Retorna determinado atributo
    ...
    /**
     * __set - Atribui valor a determinado atributo
     * @param <string> $atributo
     * @param <string> $valor
     */
    ...
    /**
     * get - Retorna tarifas de acordo com o id passado 
     * @param <int> $codigo
     * @return <array> $arrTarifa
     */
    ...
    /**
     * getValor - Retorna valor de tarifa referente ao id passado
     * @param <int> $codigo
     * @return <array> $arrValores
     */
    ...
    /**
     * getFiltrada - Retorna tarifas com ou sem filtro (rel_tarifas.php)
     * @param <string> $campo
     * @param <array> $valor
     * @return <array> $arrFiltro
     */
    ...
    /**
     * getAll - Retorna todas as tarifas
     * @return <array> $arrTarifas
     */
    ...
    /**
     * register - Registra objeto tarifa - informacoes sobre tarifa (tarifas)
     * @param <object> $tarifa
     */
    ...
    /**
     * registerValores - Registra objeto tafira - informacoes de valores (tarifas_valores) 
     * @param <object> $tarifa
     * @param <int> $id
     */
    ...
    /**
     * verifyValores - Verifica existencia de determinado valor já registrado verifica data
     * @param <string> $data
     * @return <int>
     */
    ...
    /**
     * update - Atualiza informacoes de um objeto tarifa no banco
     * @param <object> $tarifa
     */
    ...
    /**
     * remove - Remove determinada tarifa e valores de tarifa do banco
     * @param <int> $codigo
     */
