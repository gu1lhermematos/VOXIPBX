...
class Snep_Vinculos {
     ...
     * getVinculadosAgente
     * @param <string> $ramal
     * @return <array> $agentes_vinculado
     */
    ...
    /**
     * getDesvinculadosAgente
     * @param <string> $ramal
     * @return <array> $desvinculados
     */
