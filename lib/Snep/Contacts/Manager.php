...
class Snep_Contacts_Manager {
    ...
    /**
     * getAll - Method to get all contact
     */
    ...
    /**
     * get - Method to get a contact by id
     * @param <int> $id
     * @return <array>
     */
    ...
    /**
     * remove - Method to remove a contact
     * @param <int> $id
     */
    ...
    /**
     * remove - Method to remove a contacts
     * @param <int> $id
     */
    public function removeContacts($id) {
        ...
        $db = Zend_Registry::get('db');
        $db->beginTransaction();
        $sql = "DELETE FROM `contacts_names` WHERE `group`= $id ";
        $db->exec($sql);
    ...
    /**
     * edit - Method to update a contact data
     * @param <array> $data
     */
    ...
    /**
     * gesLastId - Method to return a last inserted id.
