<div class="fullWidth">
	<div class="innerWidth940">
		<h2>Exportar Logs</h2>
        <br />
        <?php echo $this->Form->create('export_calls',array('url'=>array('controller'=>'Dashboard','action'=>'generate_excel'))); ?>
        <div class="col-lg-6">
		...
		<?php echo $this->Form->button('Gerar',array('class'=>'btn btn-success','style'=>'margin-left:15px;')); ?>
...
<script>
	$('#export_callsFirstDate, #export_callsSecondDate').datepicker({
		format: 'dd-mm-yyyy'
	})
	
	$("#export_callsLogExportForm").submit(function(e){
		...
		var date1 = $("#export_callsFirstDate").val();
		var date2 = $("#export_callsSecondDate").val();
		if (date1 == ""){
